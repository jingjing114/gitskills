				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 col-sm-12 text-right">
							<ul class="nav-icons">
								<li><img class="img-circle" src="${requestScope.userInfo.getIcon()}" alt="头像" width="45px"/></li>
								<li><a href="SelectUserInfoServlet?username=${sessionScope.user.getUserName()}"><span>${sessionScope.user.getUserName()}</span></a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div id="menu-list">
						<ul class="nav-list">
							...
							<li class="dropdown magz-dropdown"><a href="#">个人中心 <i class="ion-ios-arrow-right"></i></a>
								<ul class="dropdown-menu">
									<li><a href="SelectUserInfoServlet?username=${sessionScope.user.getUserName() }"><i class="icon ion-person"></i>我的主页</a></li>
									
									<li><a href="SelectUserInfoServlet?username=${sessionScope.user.getUserName() }"><i class="icon ion-chatbox"></i> 我的评论</a></li>				
  		...
  		<span><font>${r.getReviewTime()}</font></span><br>
  		 ...
  		 <a href="#">查看所有评论</a>
					...
					<div class="col-md-8">
						...
						<div class="author">
							<figure>
								<img src="${requestScope.userInfo.getIcon()}">
							</figure>
							<div class="details">
								<div class="job">${requestScope.userInfo.getRole()}</div>
								<h3 class="name">${requestScope.userInfo.getUserName()}</h3>
								<p>工作邮箱 ：${requestScope.userInfo.getEmail()} 手机：${requestScope.userInfo.getPhone()}   <br>  
									  微信公众号：奔跑的男男</p>
									  <p>个人简介：${requestScope.userInfo.getIntroduction()}</p>
