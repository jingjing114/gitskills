...
{
	document.getElementById("div_user").innerHTML="<div  class='col-md-3 col-sm-12 text-right'><ul class='nav-icons'><li><img class='img-circle' src='${sessionScope.user.getIcon()}' width='45px'/></li><li><a href='SelectUserInfoServlet?username=${sessionScope.user.getUserName()}'><span>${sessionScope.user.getUserName()}</span></a></li></ul></div>"
}
